...
const Feature: React.FC<FeatureProps> = ({ icon, title, description }) => {
  return (
    <div className="flex flex-col items-start p-6 rounded-2xl glass-card hover:shadow-elevation-2 transition-all duration-300 ease-in-out">
      <div className="p-3 rounded-xl bg-web3-blue text-web3-indigo mb-4">
        {icon}
      </div>
    ...
    <div className="py-16 md:py-24 bg-gray-50">
      ...
      >
        <div className="flex flex-col items-center text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Everything you need for web3 payments</h2>
